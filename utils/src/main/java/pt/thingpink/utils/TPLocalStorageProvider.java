...
@TargetApi(19)
public class TPLocalStorageProvider extends DocumentsProvider {
	...
	public String createDocument(final String parentDocumentId, final String mimeType, final String displayName)
		...
		try {
			...
			Log.e(TPLocalStorageProvider.class.getSimpleName(), "Error creating new file "
                    + newFile);
		}
		return null;
	}
	...
	@Override
	public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint, final CancellationSignal signal)
			throws FileNotFoundException {
		...
		try {
			...
			Log.e(TPLocalStorageProvider.class.getSimpleName(), "Error writing thumbnail", e);
			return null;
		} finally {
			if (out != null)
				try {
					...
					Log.e(TPLocalStorageProvider.class.getSimpleName(), "Error closing thumbnail", e);
				}
		}
