...
public class TPAutofitHelper {
    ...
    /**
     * Creates a new instance of {@link TPAutofitHelper} that wraps a
     * {@link TextView} and enables automatically sizing the text to fit.
     */
    public static TPAutofitHelper create(TextView view) {
     ...
     * {@link TextView} and enables automatically sizing the text to fit.
     */
    public static TPAutofitHelper create(TextView view, AttributeSet attrs) {
     ...
     * {@link TextView} and enables automatically sizing the text to fit.
     */
    public static TPAutofitHelper create(TextView view, AttributeSet attrs, int defStyle) {
        TPAutofitHelper helper = new TPAutofitHelper(view);
        ...
        if (attrs != null) {
            ...
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.TPFontableTextView, defStyle, 0);
            sizeToFit = ta.getBoolean(R.styleable.TPFontableTextView_sizeToFit, sizeToFit);
            minTextSize = ta.getDimensionPixelSize(R.styleable.TPFontableTextView_minTextSize, minTextSize);
            precision = ta.getFloat(R.styleable.TPFontableTextView_precision, precision);
            ta.recycle();
    ...
    private TPAutofitHelper(TextView view) {
     ...
     */
    public TPAutofitHelper addOnTextSizeChangeListener(OnTextSizeChangeListener listener) {
        if (mListeners == null) {
     ...
     * changes.
     */
    public TPAutofitHelper removeOnTextSizeChangeListener(OnTextSizeChangeListener listener) {
        if (mListeners != null) {
     ...
     */
    public TPAutofitHelper setPrecision(float precision) {
     ...
     */
    public TPAutofitHelper setMinTextSize(float size) {
     ...
     * @attr ref me.grantland.R.styleable#AutofitTextView_minTextSize
     */
    public TPAutofitHelper setMinTextSize(int unit, float size) {
     ...
     */
    public TPAutofitHelper setMaxTextSize(float size) {
     ...
     * @attr ref android.R.styleable#TextView_textSize
     */
    public TPAutofitHelper setMaxTextSize(int unit, float size) {
        Context context = mTextView.getContext();
        Resources r = Resources.getSystem();
     ...
     */
    public TPAutofitHelper setMaxLines(int lines) {
        if (mMaxLines != lines) {
            mMaxLines = lines;
     ...
     */
    public TPAutofitHelper setEnabled(boolean enabled) {
        if (mEnabled != enabled) {
            mEnabled = enabled;
