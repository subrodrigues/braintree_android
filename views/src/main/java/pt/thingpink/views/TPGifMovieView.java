...
public class TPGifMovieView extends View {
	...
	public TPGifMovieView(Context context) {
		this(context, null);
	}

	public TPGifMovieView(Context context, AttributeSet attrs) {
		this(context, attrs, R.styleable.CustomTheme_gifMoviewViewStyle);
	}

	public TPGifMovieView(Context context, AttributeSet attrs, int defStyle) {
