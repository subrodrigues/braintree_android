 ...
 */
public class TPAnimatedExpandableListView extends ExpandableListView {
	/*
	...
	public TPAnimatedExpandableListView(Context context) {
		super(context);
	}

	public TPAnimatedExpandableListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public TPAnimatedExpandableListView(Context context, AttributeSet attrs, int defStyle) {
	...
	public static abstract class AnimatedExpandableListAdapter extends
		...
		private TPAnimatedExpandableListView parent;

		private static final int STATE_IDLE = 0;
		private static final int STATE_EXPANDING = 1;
		private static final int STATE_COLLAPSING = 2;

		private void setParent(TPAnimatedExpandableListView parent) {
			this.parent = parent;
		}
		...
		/**
		 * Override {@link #getChildView(int, int, boolean, android.view.View, android.view.ViewGroup)}
		 * instead.
		 */
		@Override
